  ...
  if $::operatingsystem == 'Ubuntu' or $::osfamily == 'Debian' {
    ...
    case $::operatingsystemmajrelease {
      '6': {
        ...
        #ensure_packages(['ruby193', 'ruby193-ruby-devel', 'zlib-devel', 'tar', 'gcc', 'patch', 'libicu-devel', 'ImageMagick'], {require => Package['centos-release-SCL']})
        ...
        #  path => ['/usr/bin'],
        #  require => [Package['ruby193', 'ruby193-ruby-devel', 'zlib-devel', 'tar', 'gcc', 'patch', 'libicu-devel', 'ImageMagick'], Class['phantomjs']],
        #}
